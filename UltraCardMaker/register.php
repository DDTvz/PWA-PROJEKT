...
if(isset($_POST['submit'])){
    ...
    if(!array_filter($errors)){
        ...
        if(mysqli_query($conn, $sql)){
            ...
            $table_name = $username . "_Cards";
            $create_new_user_table_sql = "CREATE TABLE $table_name (
                id INT PRIMARY KEY AUTO_INCREMENT,
                card_id INT UNIQUE,
                card_like_made ENUM('original_author','liked')
            )";
            mysqli_query($conn, $create_new_user_table_sql);
